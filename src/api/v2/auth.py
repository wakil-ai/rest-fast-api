...
from src.models.auth import DTUserCreateRequest, DTUserCreateResponse, TelegramAuth
from src.security.dependencies import verify_dt_api_key
from src.services import validate_telegram_data
from src.utils.user_management import generate_short_id
