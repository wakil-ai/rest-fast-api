...
from src.assistants.base import BaseAgent, RetrievalResult
from src.orchestration.utils import AgentRequestContext, AgentState
from src.core.config import settings
from src.core.dependencies import get_intent_classifier, get_storage_service
from src.core.logger import logger
from src.models.intent_types import LegalIntent
    ...
    async def retrieve(
        ...
        **kwargs,
        ...
        try:
            ...
            contract_result = await self.format_results(
                contract_docs, max_attachments=3
            )
