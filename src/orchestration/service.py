...
from src.core.langfuse_tracing import allm_trace_context
from src.core.logger import logger
from src.orchestration.agents import CourtClassifier, IntentClassifier, MilvusQueryAgent
from src.orchestration.agents import web_search_fallback as web_search_agent
from src.orchestration.providers import resolve_gemini_model_name
...
from src.orchestration.utils import merge_langgraph_thread_into_state_messages
...
class OrchestrationService:
    ...
    def graph(self) -> Any:
        if self._graph is None:
            from src.orchestration.graph import compile_retrieval_graph
    ...
    def _build_checkpointer(self) -> Any:
        ...
        """
        from src.orchestration.utils import _get_agent_checkpointer
