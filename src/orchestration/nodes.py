...
from src.core.langfuse_tracing import (
    LlmRunName,
    langchain_invoke_config,
    traced_ainvoke,
)
from src.orchestration.utils import current_date_context_block
from src.orchestration.retrieval import (
    resolve_assistant,
    retrieve_for_assistant,
)
from src.orchestration.state import RetrievalRewriteState
from src.orchestration.text import (
    history_text_from_state,
    message_content_to_plain_str,
)
from src.orchestration.utils import load_turn_file_context
...
async def criminal_case_retrieval_subgraph(state: RetrievalRewriteState) -> dict:
    ...
    from src.core.dependencies import get_criminal_mode_classifier
    from src.orchestration.agents.criminal_retrieval_langgraph import (
...
async def stream_final_answer(
    ...
    *,
    ...
    from src.orchestration.llms import LangChain
    from src.orchestration.utils import agent_session_thread_id
