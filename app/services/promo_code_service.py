...
class PromoCodeService:
    ...
    def get_promo_code(self, code: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"[PromoCodeService] Error getting promo code {code}: {str(e)}")
            return None
    ...
    def activate_promo_code(self, code: str) -> bool:
        ...
        try:
            ...
            logger.error(f"[PromoCodeService] Error activating promo code {code}: {str(e)}")
            return False
    ...
    def deactivate_promo_code(self, code: str) -> bool:
        ...
        try:
            ...
            logger.error(f"[PromoCodeService] Error deactivating promo code {code}: {str(e)}")
            return False
    ...
    def delete_promo_code(self, code: str) -> bool:
        ...
        try:
            ...
            if promo_result.deleted_count > 0:
                logger.info(f"[PromoCodeService] Deleted promo code '{code}' and {user_result.deleted_count} user assignments")
                return True
            return False
    ...
    def assign_promo_code_to_user(self, user_id: str, promo_code: str) -> Tuple[bool, int]:
        ...
        try:
            ...
            if existing:
                ...
                logger.info(f"[PromoCodeService] Updated promo code for user {user_id} to '{promo_code}'")
            else:
    ...
    def remove_user_promo_code(self, user_id: str) -> bool:
        ...
        try:
            ...
            if result.deleted_count > 0:
                logger.info(f"[PromoCodeService] Removed promo code from user {user_id}")
                return True
            return False
            
        except Exception as e:
            logger.error(f"[PromoCodeService] Error removing promo code from user: {str(e)}")
            return False
    
    def get_user_promo_code(self, user_id: str) -> Optional[Dict[str, Any]]:
        """
    ...
    def list_users_with_promo_codes(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.info(f"[PromoCodeService] Retrieved {len(assignments)} user promo code assignments")
            return assignments
