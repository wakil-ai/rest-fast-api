...
class StorageService:
    ...
    def __init__(self):
        ...
        try:
            ...
            logger.info(f"[StorageService] Initialized Google Cloud Storage with bucket: {self.bucket_name}")
    ...
    def delete_file(self, file_path: str) -> bool:
        ...
        try:
            ...
            logger.info(f"[StorageService] Archived file from '{file_path}' to '{archived_path}'")
            return True
        except Exception as e:
    ...
    def permanently_delete_file(self, file_path: str) -> bool:
        ...
        try:
            ...
            logger.error(f"[StorageService] Failed to permanently delete file: {str(e)}")
            return False
